...
import { AuthRequest } from '../app/middlewares/auth';
import Transcription from '../app/modules/transcribe/transcribe.model';
import { transcribeAudio } from '../app/modules/transcribe/transcribe.service';
