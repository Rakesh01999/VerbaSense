    ...
    <div className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10 flex flex-col items-center text-center">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-zinc-400 text-sm font-medium mb-8 backdrop-blur-md"
        >
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-8xl font-black text-white tracking-tighter mb-8 leading-[1.1]"
        >
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-zinc-400 max-w-3xl mb-12 font-medium leading-relaxed"
        >
        ...
        >
          <Button asChild size="lg" className="bg-white text-black hover:bg-zinc-200 text-lg px-8 py-7 rounded-full font-bold transition-all hover:scale-105 active:scale-95 shadow-xl shadow-white/10">
            <Link href="/register" className="flex items-center">
              Start Building Free <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="border-white/10 text-white hover:bg-white/5 text-lg px-8 py-7 rounded-full font-bold transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl mt-12">
          {[
            ...
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className="relative p-10 rounded-[2.5rem] bg-zinc-900/40 border border-white/5 text-left backdrop-blur-3xl overflow-hidden group"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
              <div className="relative z-10">
                <div className="mb-6 p-3 w-fit rounded-2xl bg-white/5 border border-white/10">{feature.icon}</div>
